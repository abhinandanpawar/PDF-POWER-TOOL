...
import { Braces, Sparkles, FileCog, QrCode, FileText, Gift, Award, User, Contact, LayoutTemplate, ArrowRightLeft, Quote, Milestone, GitFork, UserCircle, Heart, Smile, Badge, KeyRound, FileDown } from 'lucide-react';
